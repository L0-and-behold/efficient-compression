...
function procedure(
    ...
    tstate, logs, loss_fun = lux_training!(train_set, validation_set, test_set, loss_fun, tstate, args; min_epochs=args.min_epochs, max_epochs=args.max_epochs, shrinking=args.shrinking, layerwise_pruning_flag=args.layerwise_pruning, converge_val_loss=args.converge_val_loss, vjp=AutoEnzyme());
