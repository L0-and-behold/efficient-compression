...
class ModelByteSize:
    ...
    def get_model_info(model, device):
        ...
        Args:
            ...
            device: The device to place the model on during analysis
            
        Returns:
            dict: A dictionary with trainable and non-zero parameter counts
        """
    ...
    def get_model_matrices(model):
        ...
        Args:
            model: The PyTorch model to extract matrices from
            
        Returns:
            list: A list of tensors representing weights with biases incorporated
        """
        matrices = []
    ...
    def byte_size(model):
        ...
        Returns:
            int: The minimum of COO and CSC sparse representation sizes in bytes
        """
    ...
    def coo_size(tensor):
        ...
        Args:
            tensor: PyTorch tensor to be converted to COO format
            
        Returns:
            int: Size of the COO sparse representation in bytes
            
        Raises:
            ValueError: If tensor elements are not np.float32
        """
    ...
    def csc_size(tensor):
        ...
        Args:
            tensor: PyTorch tensor to be converted to CSC format
            
        Returns:
            int: Size of the CSC sparse representation in bytes
