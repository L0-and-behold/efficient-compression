...
class DecoderBlock(nn.Module):
    ...
    def __init__(self, d_model, num_heads, ff_hidden_layer):
        """
        Initialize with model dimension, attention heads count, and feed-forward hidden size.
        """
...
class PositionalEncoding(nn.Module):
    ...
    def __init__(self, d_model, max_len=5000):
        """
        Initialize with encoding dimension and maximum sequence length.
        """        
...
class MultiLayerTransformerDecoder(nn.Module):
    ...
    """
    def __init__(self, d_model, num_heads, ff_hidden_layer, num_layers, alphabet_size=256, pmmp = False, initial_p_value=0.5, dev = 'cuda'):
        """
        Initialize transformer with model configuration and optional PMMP parameters.
        """        
    ...
    def create_pmmp_params(self):
        ...
        In the pmmp loss function, in the part `u(θ - w γ)² + u(w² γ (1 - γ))`, the below defined p corresponds to γ, while w and u correspond to w and u
        """        
