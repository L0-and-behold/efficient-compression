...
class TransformerConfig:
    """
    Config class to handle constants by setting global variables for the model during the training process.
    Use this class by 
        1. creating an instance using one of the following model sizes: "transformer200k", "transformer800k", "transformer3.2m", "transformer4.1m", "development".
        2. Call the instance to return the parameter-dictionary.
        3. Assign the returned parameters to the global variables in the training script.
    """
    ...
    def set_global_config(self, model):
        """
